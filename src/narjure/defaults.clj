...
(def selection-count 15)                                    ; don't set higher if not on a sumpercomputer, will cause trouble
...
(def max-concepts 500)                                      ; do not make too small (less than 50) as causes cyclic issue between task-dispatcher and concept-manager
